...
To find it, go to solscan and find a PumpFun Buy IX. [Example TX](https://solscan.io/tx/4YTsR11NZoM9ejDFdMegyrPkifJiby9hu6bUQ69NRYAe5dR5FEhYd3f7UGS5h1KwmKuLSEXnwLknY8JFuExNoueo)
Check out the following image to see where to find them:
![Solscan PumpFun Buy IX Example](https://github.com/RiadZX/portfolio/tree/main/public/blog/fee_example.png)
